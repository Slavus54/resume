...
function App() {
  ...
  const [isResume, setIsResume] = createSignal(true)
  ...
  return (
      <div class="main">
          ...
          <div onClick={() => setIsResume(!isResume())} class='picker'>{isResume() ? 'Личность' : 'Резюме'}</div>
          ...
          {isResume() ? 
              <>
                  <span class="about">
                      ...
                      Желаемый доход: <b>40 тыс.</b> || Уровень: <span id='pined'>Junior +</span>
                  </span>
            ...
            :
              <>                  
                  ...
                  <div class='items'>
                    {moves.map(el => <p class='move'>{el}</p>)}
                  </div>
